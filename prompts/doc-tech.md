...
Skills: ~/.config/opencode/skills/tech-speccreate/SKILL.md
...
5. Generate `<nodo>_tech-spec.md` using template at `~/.config/opencode/skills/tech-speccreate/references/template.md`.
