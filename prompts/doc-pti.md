...
|---|---|---|---|
| `<sistema>` | sistema | `D:\Obsidian\ClickSeguros\<sistema>\` | `<sistema>_requirements.md`, `<sistema>_prd.md` |
| `<sistema>/<modulo>` | modulo | `D:\Obsidian\ClickSeguros\<sistema>\modules\<modulo>\` | `<modulo>_requirements.md`, `<modulo>_prd.md` |
| `<sistema>/<modulo>/<submodulo>` | submodulo | `D:\Obsidian\ClickSeguros\<sistema>\modules\<modulo>\modules\<submodulo>\` | `<submodulo>_requirements.md`, `<submodulo>_prd.md` |
